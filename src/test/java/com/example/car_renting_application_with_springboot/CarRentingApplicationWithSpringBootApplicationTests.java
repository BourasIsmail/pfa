...
import ma.inpt.rentingCarApp.CarRentingApplication;
...
class CarRentingApplicationWithSpringBootApplicationTests {
    ...
    public CarRentingApplicationWithSpringBootApplicationTests(CarService carService, UserService userService, NotificationService notificationService, BCryptPasswordEncoder pwEncoder, MidnightApplicationRefresh midAppRef) {
    ...
    void contextLoads() {
        ...
        User user1 = new User("houda", pwEncoder.encode("houda"), "houda@gmail.com", "houda", "el-jonhy", "el omrane 1, rue 1, lot 6", "066666666", "Meknes");
        user1.setRole("ROLE_ADMIN");

        User user2 = new User("snoussi", pwEncoder.encode("ismail"), "ismail@gmail.com", "ismail", "Bouras", "rabat rabat", "0655225804", "Rabat");
